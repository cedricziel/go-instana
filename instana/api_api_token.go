...
func (a *APITokenApiService) DeleteApiToken(ctx _context.Context, apiTokenId string) (*_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/settings/api-tokens/{apiTokenId}"
	localVarPath = strings.Replace(localVarPath, "{"+"apiTokenId"+"}", _neturl.QueryEscape(parameterToString(apiTokenId, "")), -1)
