...
func (a *WebsiteCatalogApiService) GetWebsiteTagCatalog(ctx _context.Context, beaconType string, useCase string) (TagCatalog, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/website-monitoring/catalog"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

	localVarQueryParams.Add("beaconType", parameterToString(beaconType, ""))
	localVarQueryParams.Add("useCase", parameterToString(useCase, ""))
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
