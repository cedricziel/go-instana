...
@return ScopedGroup
*/
func (a *GroupsApiService) CreateGroup(ctx _context.Context, scopedGroup ScopedGroup) (ScopedGroup, *_nethttp.Response, error) {
	var (
...
@return ScopedGroup
*/
func (a *GroupsApiService) UpdateGroup(ctx _context.Context, id string, scopedGroup ScopedGroup) (ScopedGroup, *_nethttp.Response, error) {
	var (
